  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'SignedUploadFiles':
          return SignedUploadFiles.fromJson(value);
        case 'Survey':
          return Survey.fromJson(value);
        case 'User':
          return User.fromJson(value);
        case 'UserDiagnoses':
          return UserDiagnoses.fromJson(value);
        case 'UserLocation':
          return UserLocation.fromJson(value);
        case 'UserQuestions':
          return UserQuestions.fromJson(value);
        case 'UserReadings':
          return UserReadings.fromJson(value);
        case 'UserStatus':
          return UserStatus.fromJson(value);
        case 'UserStatus1':
          return UserStatus1.fromJson(value);
        case 'UserSymptoms':
          return UserSymptoms.fromJson(value);
        default:
          {
            Match match;
            if (value is List &&
